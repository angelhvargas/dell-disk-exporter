...
// Mock getNVMeDrives function to avoid actual lsblk execution
func mockGetNVMeDrives() ([]string, error) {
...
func TestUpdateMetrics(t *testing.T) {
  ...
  "thm_temp2_total_time" : 0
	...
	// Mock getNVMeDrives function
	originalDetectNVMeDrives := detectNVMeDrives
	detectNVMeDrives = mockGetNVMeDrives
	defer func() { detectNVMeDrives = originalDetectNVMeDrives }()
